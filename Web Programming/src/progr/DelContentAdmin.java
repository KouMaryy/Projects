...
/**
 * Servlet implementation class DelContentAdmin
 */
@WebServlet("/DelContentAdmin")
public class DelContentAdmin extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DelContentAdmin() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    try {
			...
			String sql="UPDATE users SET usertype=3 WHERE username=?";
